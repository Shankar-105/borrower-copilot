...
export const SAMPLE_BORROWERS = {
  ...
  Anita: { name: 'Anita', age: 35, city: 'Hubballi', incomeType: 'variable', monthlyIncome: null, incomeLow: 26000, incomeHigh: 30000, documentedAnnualIncome: null, existingEmi: 3500, otherHouseholdIncome: null, housingType: 'own', monthlyRent: 0, creditStatus: 'unknown', creditScore: null, requestedAmount: 150000, purpose: 'vehicle', loanType: 'vehicle', collateralValue: 0, recentBounce: true, highCostDebt: true, tenureMonths: 36 },
}
