...
function App() {
  ...
  const update = (key, value) => setProfile((current) => {
    ...
    if (key === 'housingType' && next.housingType === 'rent' && current.housingType === 'own') next.monthlyRent = null
  ...
  return <div className="app-shell">
    ...
    {stage === 'result' && <Result result={result} onBack={() => setStageState('form')} onReset={reset} />}
  </div>
}
